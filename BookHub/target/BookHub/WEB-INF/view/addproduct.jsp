...
<label>Supplier:</label> 
 <form:select path="supplier" items="${suppliers}"  class="form-control" >
 <form:options itemLabel="${supplier.supplierName}" itemValue="${supplier.supplierId}" class="form-control" />
</div> 
</form:select>
...
<div class="form-group">
	...
	<form:options itemLabel="${category.name}" itemValue="${category.categoryId}" class="form-control"/>
	</form:select>
</div>	
